...
print()
f_in = input(' Starting fraction of x domain to plot (default 0.625)? ')
fx1 = float(f_in or 0.625)
f_in = input(' Ending fraction of x domain to plot (default 0.84375)? ')
fx2 = float(f_in or 0.84375)
f_in = input(' Starting fraction of y domain to plot (default 0)? ')
fy1 = float(f_in or 0.0)
f_in = input(' Ending fraction of y domain to plot (default 0.5)? ')
fy2 = float(f_in or 0.5)
