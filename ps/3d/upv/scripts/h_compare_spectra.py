...
# 3 separate directories specified below.
...
#=================================================================
if option==1:
   suffix='_n'+str(ng)+'_t'+str(int(t+0.01))+'.eps'
   ...
   suffix='_n'+str(ng)+'_bal_t'+str(int(t+0.01))+'.eps'
   ...
   suffix='_n'+str(ng)+'_imb_t'+str(int(t+0.01))+'.eps'
...
dir_list=['../3d/swnh/ng'+str(ng)+'ld0.5r001/','../plane/sw/swps/vstrip/ng'+str(ng)+'ld0.5r001/','../plane/gn/gnps/vstrip/ng'+str(ng)+'ld0.5r001/']
# Corresponding labels on the curves plotted:
label_list=['3D','SW','GN']
# Corresponding line styles:
dashlist=[(1,0.0001),(8,3),(2,5)]
...
#=========================================================================
# Save image:
fig1.savefig('h'+suffix, format='eps', dpi=1200)
