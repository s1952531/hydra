...
ini-accel: $(objects) $(fft_lib) $(sourcedir)/post/ini-accel.f90
	$(f90) $(fft_lib) parameters.o constants.o spectral.o $(sourcedir)/post/ini-accel.f90 -o ini-accel $(flags)

pressure: $(objects) $(fft_lib) $(sourcedir)/post/pressure.f90
	$(f90) $(fft_lib) parameters.o constants.o spectral.o $(sourcedir)/post/pressure.f90 -o pressure $(flags)
