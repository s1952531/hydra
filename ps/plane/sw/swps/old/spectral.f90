...
double precision:: helm(ng,ng),rlap(ng,ng)
double precision:: c2g2(ng,ng),simp(ng,ng)
double precision:: filt(ng,ng),dissi(ng,ng)
...
double precision:: anu,rkfsq,fsq,opak
integer:: kx,ky,k
...
do ky=1,ng
  do kx=1,ng
    ...
    simp(kx,ky)=one/((hdti**2-opak)*(one+dt2*dissi(kx,ky)))
