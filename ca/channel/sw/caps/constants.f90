...
double precision,parameter:: ap=glyi**2,hglyi=glyi/two

 !Constants involving physical parameters:
double precision,parameter:: csq=cgw**2,csqi=one/csq,cofi=one/cof
double precision,parameter:: kd=cof/cgw,kdsq=kd**2,ldsq=one/kdsq
double precision,parameter:: geo=csq/cof,geoi=one/geo,pmcc=geo/elly
