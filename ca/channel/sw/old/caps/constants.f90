...
double precision,parameter:: ap=glyi**2,ape=two*ap,c0=two*glyi,hglyi=glyi/two

 !Various constants involving physical & numerical parameters:
double precision,parameter:: kdsq=(cof/cgw)**2,csq=cgw**2
double precision,parameter:: csqi=one/csq,c0f=c0*cof
double precision,parameter:: geo=csq/cof
