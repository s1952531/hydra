...
dqi=one/dq
qbase=dq*dble(nlevm)
 !qbase: should be a large integer multiple of the contour interval, dq.  
...
levbeg=int((qbase+qamin)*dqi+f12)+1
levend=int((qbase+qamax)*dqi+f12)
