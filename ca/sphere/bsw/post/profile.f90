...
open(21,file='hini.asc',status='replace')
open(22,file='uini.asc',status='replace')
open(23,file='qini.asc',status='replace')
...
open(21,file='havg.asc',status='replace')
open(22,file='uavg.asc',status='replace')
open(23,file='qavg.asc',status='replace')
...
write(*,*)
write(*,*) ' The results are ready in havg.asc, uavg.asc and qavg.asc'
write(*,*)
write(*,*) ' View using e.g. plotcol havg.asc hini.asc'
