...
!***OpenMP parameter specifying number of parallel processors to use:
integer,parameter:: nthreads=NUM_THREADS
...
!***Physical parameters:***
double precision,parameter:: omega=OMEGA,rekman=R_EKMAN,esr=ESR
