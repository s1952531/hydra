...
!$omp do private(xgt,qdy,isy,ncrloc,inc,kob)
  do ix=1,ntu
    xgt=xgu(ix)
...
!$omp do private(ygt,qdx,isx,ncrloc,inc,kob)
  do iy=1,ngu-1
    ygt=ygu(iy)
