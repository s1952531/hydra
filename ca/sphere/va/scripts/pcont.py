...
print
prefix=str(raw_input(' Data file prefix (hh, dd, gg, qq, ...; default hh)? ') or 'hh')
filename=prefix+'.r4'
...
frame=int(raw_input(' Frame to read (0 for first; default 30)? ') or 30)
...
opt=str(raw_input(' Add axis labels and ticks (y/n; default y)? ') or 'y')
