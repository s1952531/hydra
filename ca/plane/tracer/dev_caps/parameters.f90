...
double precision,parameter:: tgsave=1.d0,tcsave=5.d0
...
double precision,parameter:: anu=100.d0,nnu=3
double precision,parameter:: esr=0.d0,vorvor=0.d0
...
! anu    : hyperdiffusivity coefficient
