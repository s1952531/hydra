...
do j=1,nq,nskip
  ...
  do
    ...
    if ((.not. crossx) .and. (.not. crossy)) then 
      i=ia
      write(88,'(a,2(f9.1))') 'L',(xq(i)-xmin)*scalex,(ymax-yq(i))*scaley 
    else 
...
!          write(*,*) 'px < py',px,py
          ...
          i=ia
          write(88,'(a,2(f9.1))') 'L',(xxa-xmin)*scalex,(ymax-yyy)*scaley 
          write(88,'(a,2(f9.1))') 'M',(xxb-xmin)*scalex,(ymax-yyy)*scaley 
          write(88,'(a,2(f9.1))') 'L',(xxx-xmin)*scalex,(ymax-yya)*scaley 
          write(88,'(a,2(f9.1))') 'M',(xxx-xmin)*scalex,(ymax-yyb)*scaley 
          write(88,'(a,2(f9.1))') 'L',(xq(i)-xmin)*scalex,(ymax-yq(i))*scaley 
        else
!          write(*,*) 'px > py',px,py
          xtm=xq(ia)-xq(i)
