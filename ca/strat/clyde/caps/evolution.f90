...
if (zjump .gt. zero) then 
  ...
  call main_invert(zs,uu,vv,vsea,uriv,vriv)
...
call main_invert(zz,uu,vv,vsea,uriv,vriv)
...
call zztend(szd,szs,t)
 ...
 !Read sea and river flow speeds:
!read(50,*) t,vsea,uriv,vriv
!TO BE IMPLEMENTED!!!   Need to time interpolate..... along with conformal map
