...
min_vals[:,1], min_vals[:,1] = get_layer_min_max(raw_array, nz, NH, N)
...
min_vals[:,0], min_vals[:,0] = get_layer_min_max(raw_array, nz, NH, N)
...
min_vals[:,2], min_vals[:,2] = get_layer_min_max(raw_array, nz, NH, N)
